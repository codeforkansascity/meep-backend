...
def test_get_project_list(app, new_project, another_project):
    """
    ...
    with app.test_client() as client:
        ...
        test_new_project = {"id": resp_projects[0].get("id"), "name": "someTestName", "description": "testDescription", "photoUrl": "www.google.com", "websiteUrl": "www.aol.com", "year": 1999, "ggeReduced": 1.234, "ghgReduced": 2.234 }
        test_another_project = {"id": resp_projects[1].get("id"), "name": "anotherTestName", "description": "anotherDescription", "photoUrl": "www.yahoo.com", "websiteUrl": "www.myspace.com", "year": 2000, "ggeReduced": 3.234, "ghgReduced": 4.234 }
...
def test_get_locations_list(app, new_location, another_location):
    ...
    with app.test_client() as client:
        ...
        test_new_location = {"id": resp_locations[0].get("id"), "address": "1 Infinite Loop", "city": "Cupertino", "state": "CA", "zipCode": 95014, "longitude": -94.668954, "latitude": 38.992762 }
        test_another_location = {"id": resp_locations[1].get("id"), "address": "456 test way", "city": "Kansas City", "state": "KS", "zipCode": 66210, "longitude": -83.654321, "latitude": 39.654321 }
